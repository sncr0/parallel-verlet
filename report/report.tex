...
\section{Literature Review}
    ...
    \begin{align*}
        ...
        \end{bmatrix}  
    \end{align*}
    Each processor is responsible for a sub-block of $f$ of size $N/\sqrt{P} \times N/\sqrt{P}$.
    This allows for a reduction of the communication cost from $O(N)$ to $O(N/\sqrt{P})$. 
...
individual level.
    ...
    In the following subsections, plots of the speedup in regard to the number of threads will be given. In order to 
...
\section{Conclusion}
Overall, Section~\ref{res} makes it clear that the nonbonded interactions are ideal for parallelization. It is likely
